...
##The Gas Price formula in the Aurora Documentation states that total gas price T is bound to (base cost * gas price) at point t and (base cost * gas price) at t+1. 
